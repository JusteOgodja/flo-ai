...
- [Flo AI 🌊](#flo-ai-)
  - [🎨 Flo AI Studio - Visual Workflow Designer](#-flo-ai-studio---visual-workflow-designer)
    ...
    - [🏃‍♂️ Quick Start with Studio](#️-quick-start-with-studio)
  - [✨ Features](#-features)
  ...
  - [🔧 Variables System](#-variables-system)
    ...
    - [Variables in User Input](#variables-in-user-input)
    - [Multi-Agent Variable Sharing](#multi-agent-variable-sharing)
    - [YAML Configuration with Variables](#yaml-configuration-with-variables)
    - [Error Handling and Validation](#error-handling-and-validation)
    - [Best Practices](#best-practices)
  - [🛠️ Tools](#️-tools)
    - [🎯 @flo\_tool Decorator](#-flo_tool-decorator)
  ...
  - [🔄 Agent Orchestration with Arium](#-agent-orchestration-with-arium)
    ...
    - [📄 YAML-Based Arium Workflows](#-yaml-based-arium-workflows)
      - [Simple YAML Workflow](#simple-yaml-workflow)
      - [Advanced YAML Workflow with Tools and Routing](#advanced-yaml-workflow-with-tools-and-routing)
      ...
      - [YAML Workflow with Variables](#yaml-workflow-with-variables)
      - [Using Pre-built Agents in YAML Workflows](#using-pre-built-agents-in-yaml-workflows)
      - [YAML Workflow Best Practices](#yaml-workflow-best-practices)
      - [What Can Be Defined in YAML vs Python](#what-can-be-defined-in-yaml-vs-python)
      - [Benefits of YAML Workflows](#benefits-of-yaml-workflows)
